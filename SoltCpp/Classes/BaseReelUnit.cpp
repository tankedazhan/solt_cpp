...
void BaseReelUnit::createSymbolCsbFullReel()
{
	...
	CCLOG("=========================================================%d", this->m_symbolCurrentNum);
	CCLOG("=========================================================%d", this->m_roll_list1[this->m_symbolCurrentNum]);
	...
	else
	{
		...
		//auto end_unit = *this->m_symbolUnitList.end();
